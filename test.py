...
df=spark.read.format('csv').option("header",True).option('sep',',').schema(eval(schema)).load("D:\Databricks\SRC\Delivery_data/09-06-2023-TO-09-09-2023-RAJESHEXPO-ALL-N.csv")
